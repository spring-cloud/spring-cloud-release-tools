...
public class DryRunCompositeTask implements CompositeReleaserTask {
	...
	public void accept(Arguments args) {
		...
		Map<String, DryRunReleaseReleaserTask> releaseTasks = this.context.getBeansOfType(DryRunReleaseReleaserTask.class);
		log.info("Found the following dry run tasks {}", releaseTasks);
